                            ...
                            <li class="nav-item dropdown">
                                <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    {{-- <img src="assets/images/avatar/demi.png" class="rounded-circle" width="32"
                                        alt="Frontted"> --}}
                                        <img src="{{Avatar::create(auth()->user()->name)->setDimension(40)->setFontSize(18)->toBase64()}}" alt="{{auth()->user()->name}}">
                                    ...
                                    <div class="dropdown-item-text dropdown-item-text--lh">
                                        ...
                                        <div class="text-muted">
                                            @foreach (auth()->user()->roles as $role)
                                                <span class="badge bg-success text-light">{{ $role->name }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar sidebar-light sidebar-left sidebar-p-t" data-perfect-scrollbar>
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li class="sidebar-menu-item">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="post_menu">
                                    <li class="sidebar-menu-item">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="post_menu">
                                        <li class="sidebar-menu-item {{Route::is('post.index') ? 'active' : ''}}">
                                            <a class="sidebar-menu-button" href="{{route('post.index')}}">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="post_menu">
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="{{route('category.index')}}">
                                                <span class="sidebar-menu-text">Catagory</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="sidebar-submenu collapse" id="post_menu">
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="{{route('backend.user.index')}}">
                                                <span class="sidebar-menu-text">Tag</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-menu-item">
                                    ...
                                    <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="">
                                                <span class="sidebar-menu-text">Add Roles</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="sidebar-submenu collapse" id="role_menu">
                            ...
                            <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account">
                                <a href="profile.html"
                                    ...
                                    <span class="flex d-flex flex-column">
                                        ...
                                        @foreach (auth()->user()->roles as $role)
                                                <span class="badge bg-primary w-25 text-light">{{ $role->name }}</span>
                                            @endforeach
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <div class="dropdown-item-text dropdown-item-text--lh">
                                            ...
                                            <div class="text-muted">
                                                @foreach (auth()->user()->roles as $role)
                                                    <span
                                                        class="badge bg-success text-light">{{ $role->name }}</span>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="dropdown-divider"></div>
